...
[_BL] = LAYOUT(
  KC_GESC,KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_BSPC,KC_DEL, KC_P7,  KC_P8,  KC_P9,  KC_PAST, \
   ...
   CTL_T(KC_LBRC),KC_LGUI,KC_LALT,LT(_LeftS, KC_SPC), LT(_RightS, KC_SPC), KC_UNDS,LT(_RS,KC_RBRC),KC_LEFT,KC_DOWN,KC_RGHT,KC_P0,  KC_PDOT,KC_PENT ),

[_SL] = LAYOUT(
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_EQL, _______,_______,_______,_______, \
...
[_LeftS] = LAYOUT(
  DF(_BL),KC_EXLM,KC_AT,  KC_HASH,KC_DLR, KC_PERC,KC_CIRC,KC_AMPR,KC_ASTR,KC_LBRC,KC_RBRC,KC_EQL, KC_PLUS,KC_NLCK,_______,_______,KC_VOLU, \
  ...
  LSFT_T(KC_LBRC),   _______,_______,_______,_______,_______,_______,_______,_______,_______,RSFT_T(KC_RBRC), KC_PGUP, _______,_______,_______,KC_PEQL, \
   _______,  _______,  _______,        _______,            KC_MINS,      KC_APP,  _______,KC_HOME,KC_PGDN,KC_END, _______,_______,_______ ),

[_RightS] = LAYOUT(
  DF(_SL),KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_UNDS,KC_MINS,_______,_______,_______,_______, \
...
LSFT_T(KC_QUES),   _______,_______,_______,_______,_______,_______,_______,_______,_______,RSFT_T(KC_SLSH), _______, _______,_______,_______,_______, \
